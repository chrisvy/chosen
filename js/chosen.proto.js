(function() {
  ...
  this.Chosen = (function(_super) {
    ...
    Chosen.prototype.destroy = function() {
      ...
      _ref = ['chosen:updated', 'chosen:activate', 'chosen:open', 'chosen:close'];
    ...
    Chosen.prototype.search_field_disabled = function() {
      var _ref;
      this.is_disabled = this.form_field.disabled || ((_ref = this.form_field.up('fieldset')) != null ? _ref.disabled : void 0) || false;
      if (this.is_disabled) {
    ...
    Chosen.prototype.container_mousedown = function(evt) {
      ...
      if (evt && ((_ref = evt.type) === 'mousedown' || _ref === 'touchstart') && !this.results_showing) {
        evt.preventDefault();
      }
